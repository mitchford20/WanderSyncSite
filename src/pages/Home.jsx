...
function Home() {
  return (
    <div className="flex flex-col space-y-8 items-center">
      ...
      <img src="/placeholder.svg?height=300&width=500" alt="WanderSync App Screenshot" className="rounded-lg shadow-md transition-transform duration-300 hover:scale-105" />
    </div>
  );
}
